...
//       try {
//         const response = await axios.get('http://localhost/capstone/index.php');
...
//       try {
//         const response = await axios.get('http://localhost/capstone/index4.php');
...
//         </thead>
//         <tbody>
//           {guestData.map((guestItem, index) => (
//             <tr key={index}>
//               <td>{guestItem.name}</td>
//               <td>
//                 <img src={bookingData[index].photo} alt="Room" style={{ width: '150px', height: '150px' }} />
//               </td>
//               <td>{bookingData[index].room_number}</td>
//               <td>{bookingData[index].room_price}</td>
//               <td>{bookingData[index].room_ammen}</td>
